...
(function(){
	...
	var blagoon_new_game_scene_battle_createPartyCommandWindow = Scene_Battle.prototype.createPartyCommandWindow;

	Scene_Battle.prototype.createPartyCommandWindow = function() {
		// aliasing the party command window since I added Equip on the original window.
		// 6/26/2020
		// for my game Bakunawa Lagoon
		blagoon_new_game_scene_battle_createPartyCommandWindow.call(this);
	...
	Window_SlantedHud.prototype.drawActorHudFace = function(faceName, x, y) {
    ...
    Window_SlantedHud.prototype.drawGauge = function(x, y, width, rate, color1, color2) {
    ...
    Scene_Battle.prototype.createSlantedHud = function() {
        ...
        for (var i = 0; i < $gameParty.members().length; i++) {
			...
			switch($gameParty.members().length) {
				case 1:
					window.x = i * SOUL_MV.DestinyEngine.BattleHUD.Feena.battleHudSpacing + 550;
					break;
				case 2:
					window.x = i * SOUL_MV.DestinyEngine.BattleHUD.Feena.battleHudSpacing + 500;
					break;
				case 3:
					window.x = i * SOUL_MV.DestinyEngine.BattleHUD.Feena.battleHudSpacing + 450;
					break;
				case 4:
					window.x = i * SOUL_MV.DestinyEngine.BattleHUD.Feena.battleHudSpacing + 400;
					break;
				case 5:
					window.x = i * SOUL_MV.DestinyEngine.BattleHUD.Feena.battleHudSpacing + 350;
					break;
				case 6:
					window.x = i * SOUL_MV.DestinyEngine.BattleHUD.Feena.battleHudSpacing + 250;
					break;
				case 7:
					window.x = i * SOUL_MV.DestinyEngine.BattleHUD.Feena.battleHudSpacing + 150;
					break;
				case 8:
        ...
        for (var i = 0; i < $gameParty.members().length; i++) {
			...
			switch($gameParty.members().length) {
				case 1:
					window.x = xloc + SOUL_MV.DestinyEngine.BattleHUD.Feena.hudXPadding + 560;
					break;
				case 2:
					window.x = xloc + SOUL_MV.DestinyEngine.BattleHUD.Feena.hudXPadding + 520;
					break;
				case 3:
					window.x = xloc + SOUL_MV.DestinyEngine.BattleHUD.Feena.hudXPadding + 470;
					break;
				case 4:
					window.x = xloc + SOUL_MV.DestinyEngine.BattleHUD.Feena.hudXPadding + 420;
					break;
				case 5:
					window.x = xloc + SOUL_MV.DestinyEngine.BattleHUD.Feena.hudXPadding + 370;
					break;
				case 6:
					window.x = xloc + SOUL_MV.DestinyEngine.BattleHUD.Feena.hudXPadding + 270;
					break;
				case 7:
					window.x = xloc + SOUL_MV.DestinyEngine.BattleHUD.Feena.hudXPadding + 170;
					break;
				case 8:
					window.x = xloc + SOUL_MV.DestinyEngine.BattleHUD.Feena.hudXPadding + 10;
					break;
				default:
